...
const ActionTriggerCard = ({ rate, loadings }) => {
  const { skin } = useSkin();
  ...
  return (
    ...
    >
      ...
      >
        <div>ActionTriggersId : {rate.ActionTriggersId}</div>
        <div className="d-flex align-items-center">
          <Button
            onClick={() => navigate("/rules/action_triggers/update")}
            style={{ marginRight: 8 }}
            color="primary"
            size="sm"
          >
...
export default ActionTriggerCard;
