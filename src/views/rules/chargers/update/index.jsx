...
const ChargersUpdate = () => {
  ...
  const { updateChargerController, loadings } = useChargers();
              ...
              {updateChargerController.values.FilterIDs.map((item, index) => (
                <Col xs="12" className="mb-1 d-flex align-items-center">
                  ...
                  <button
                    ...
                    onClick={() => {
                      let array = [...updateChargerController.values.FilterIDs];
                      array = array.filter((intem, i) => i !== index);
                      updateChargerController.setFieldValue("FilterIDs", array);
                    }}
                  >
